...
DADOS_DEUSES = {
    #"DEUS": [CUSTO, ALCANCE, DANO, CADENCIA DE ATAQUE, COR DO ATAQUE (R, G, B)]
    "Zeus":   [100, 100, 7, 50, (255, 215, 0)],
    "Anubis": [200, 270, 12, 80, (213, 0, 255)],
    "Odin":   [300, 140, 24, 60, (0, 128, 255)]
}
...
FASE_SCRIPT = [  
    ...
    [
        ...
        ("FANTASMA_1", 4, 20, 0, 30, 180), 
        ("BOSS_1", 3, 1, 1, 10, 700),
        ("FANTASMA_2", 1, 20, 0, 30, 450), 
        ("BOSS_2", 2, 1, 2, 0, 700),
        ("FANTASMA_1", 6, 20, 0, 40, 180),
        ("FANTASMA_2", 5, 15, 0, 10, 180),  
        ("BOSS_3", 4, 1, 3, 0, 0)
    ],
    ...
    [
        ...
        ("BOSS_1", 2, 1, 1, 0, 300),
        ("FANTASMA_3", 2, 5, 0, 70, 200),
        ("FANTASMA_2", 1, 10, 0, 15, 250),
        ("FANTASMA_3", 2, 5, 0, 70, 100),
        ("BOSS_2", 2, 1, 2, 0, 400),
        ("FANTASMA_1", 3, 15, 0, 15, 100),
        ("FANTASMA_2", 2, 10, 0, 20, 100),
        ("FANTASMA_1", 3, 15, 0, 15, 100),
        ("FANTASMA_1", 8, 30, 0, 20, 100),
        ("BOSS_3", 6, 1, 3, 0, 0)
    ],

[
    ("FANTASMA_1", 15, 15, 0, 60, 520), 
    ("FANTASMA_1", 3, 15, 0, 50, 180), 
    ("FANTASMA_2", 1, 10, 0, 40, 200), 
    ("FANTASMA_3", 2, 5, 0, 80, 150),   
    ("BOSS_1", 9, 1, 1, 0, 600), 
    ("FANTASMA_1", 5, 25, 0, 30, 200),
    ("FANTASMA_2", 14, 15, 0, 25, 150), 
    ("FANTASMA_1", 18, 40, 0, 15, 300),
    ("FANTASMA_3", 6, 8, 0, 70, 100),  
    ("FANTASMA_2", 11, 10, 0, 30, 150),  
    ("BOSS_2", 9, 1, 2, 0, 700),        
    ("FANTASMA_3", 15, 6, 0, 50, 100),
    ("FANTASMA_1", 15, 10, 0, 40, 120), 
    ("FANTASMA_2", 29, 15, 0, 20, 100),  
    ("FANTASMA_3", 24, 5, 0, 60, 50),
    ("FANTASMA_1", 30, 20, 0, 20, 200), 
    ("BOSS_3", 12, 1, 3, 0, 0)           
]
